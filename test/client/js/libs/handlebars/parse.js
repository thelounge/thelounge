...
describe("parse Handlebars helper", () => {
	...
	it("should find urls", () => {
		const testCases = [{
			...
			expected:
				"<a href='www.nooooooooooooooo.com' target='_blank' rel='noopener'>" +
			...
			expected:
				"use " +
				"<a href='www.duckduckgo.com' target='_blank' rel='noopener'>" +
					"www.duckduckgo.com" +
				"</a>" +
				" for privacy reasons"
		}, {
	...
	it("should balance brackets", () => {
		const testCases = [{
			...
			expected:
				"abc (" +
				"<a href='www.example.com' target='_blank' rel='noopener'>" +
					"www.example.com" +
				"</a>" +
				")"
		}, {
			...
			expected:
				"<a href='www.example.com/Test_(Page)' target='_blank' rel='noopener'>" +
