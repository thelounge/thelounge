...
function index(req, res, next) {
	...
	return fs.readFile("client/index.html", "utf-8", function(err, file) {
		...
		res.setHeader("Content-Security-Policy", "default-src *; connect-src 'self' ws: wss:; style-src * 'unsafe-inline'; img-src * data:; script-src * 'unsafe-inline'; child-src 'self'; object-src 'none'; form-action 'none'; referrer no-referrer;");
